...
Python, MySQL
### AI/ML Frameworks
PyTorch, Sentence Transformers, LangChain, RAGAS, ChromaDB, BM25, Ollama
### Backend
FastAPI, JWT authentication, role-based access control
### Frontend
...
- Added FastAPI backend and React/TypeScript frontend
- Implemented JWT-based authentication and role-based admin access
- Added stage-level monitoring for latency, success rate, and throughput
- Integrated RAG evaluation workflow using retrieval and generation-quality metrics
